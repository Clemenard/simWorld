...
let html=''
let totalStat=utils.racialTraits();
...
html+='             <h3 class="col-12">Racial traits</h3>'
html+='             <p class="avatar-trait col-4" id="av-for">Force <br><strong> '+totalStat[1]+'</strong></p>'
html+='             <p class="avatar-trait col-4" id="av-end">Endurance <br><strong> '+totalStat[2]+'</strong></p>'
html+='             <p class="avatar-trait col-4" id="av-agi">Agilité <br><strong> '+totalStat[3]+'</strong></p>'
html+='             <p class="avatar-trait col-4" id="av-dex">Dextérité <br><strong> '+totalStat[4]+'</strong></p>'
html+='             <p class="avatar-trait col-4" id="av-int">Intelligence <br><strong> '+totalStat[5]+'</strong></p>'
html+='             <p class="avatar-trait col-4" id="av-sag">Sagesse <br><strong> '+totalStat[6]+'</strong></p>'
html+='     </div>'
html+='</div>'
